...
def format_search_result(
    ...
    result = {
        ...
        "source_marketplace": final_output.get("source_marketplace"),
        "source_item_id": final_output.get("source_item_id"),
        "legacy_item_id": final_output.get("legacy_item_id"),
        "buying_options": list(final_output.get("buying_options") or []),
        "country": final_output.get("country"),
        "city": final_output.get("city"),
        "item_created_at": final_output.get("item_created_at"),
        "item_end_at": final_output.get("item_end_at"),
        "evidence_role": final_output.get("evidence_role"),
        "price_role": final_output.get("price_role"),
